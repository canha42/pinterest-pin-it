...
function pibfi_CheckContentWidth() {
	...
	// Set to standard:
	if ( '1024' == $standardImageW && ! $contentWidth ) add_action( 'admin_notices' , create_function( '', "echo '<div class=error><p>Your maximum image width is thought to be 1024 pixels. <strong>This might be incorrect and might affect the functionality of the Pinterest Pin It plugin</strong>. Please check the <a href=\"options-general.php?page=pibfi_Engine_id\">plugins settings</a>.</p></div>';" ) );

	// Non existent:
	elseif ( ! $standardImageW && ! $contentWidth ) add_action('admin_notices' , create_function( '', "echo '<div class=error><p>No maximum image width has been detected. This might affect the functionality of the <strong>Pinterest Pin It</strong> plugin. Please check the <a href=\"options-general.php?page=pibfi_Engine_id\">plugin settings</a>.</div>';" ) );
}
